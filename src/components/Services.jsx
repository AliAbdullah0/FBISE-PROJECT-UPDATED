...
function Services() {
  return (
    <>
    <section class="relatve bg-gray-950">
...
<span className='mt-3 font-semibold tracking-wide text-blue-300'><span className='text-xl text-indigo-400 font-semibold'>Contact Me:</span>@shahajlal6969@gmail.com | 03239811654</span><br />
<span className='mt-3 font-semibold tracking-wide text-blue-300'><span className='text-xl text-indigo-400 font-semibold'>Contact Me:</span>@aliabdullah10nov2006@gmail.com | 03197055066</span>
